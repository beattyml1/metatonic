...
export class FieldBuilder extends React.Component<FieldBuilderEvents & FieldBuilderProps, any> {
    render() {
        return (
            <div className="field-builder">
                ...
                <label>
                    Type
                    <TypeSelector field={this.props.field} records={this.props.records} onChange={this.onFieldPropChange('typeName')}/>
                </label>
                <fieldset>
    ...
    onFieldPropChange(prop) {
        return (value) => this.props.onFieldPropChange(this.props.record.name, this.props.field.name, prop, value);
    }
}

export const FieldBuilderBound = connect(
    (state: any) => (state.appBuilder as FieldBuilderProps),
    (dispatch) => ({
        onFieldPropChange: (recordName, fieldName, propName, value) =>
