metastore is designed to be a store layer that handles gray areas between domain and infrastructure that are common to almost all data entry/enterprise apps
# Features
- History/Versioning
- Soft Deletes
- Finilization/status
